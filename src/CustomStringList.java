...
//
//
//Данный метод получает в качестве аргумента строку и проверяет, находится ли эта строка в
// списке строк или нет. Если да, метод возвращает true, в ином случае false.
//2. Метод check
//
//Данный метод получает в качестве аргумента массив из строк и проверяет, находятся ли
// строки из полученного списка в списке строк list. Если все находятся, метод возвращает true, в ином случае false.
//3. Метод longestWord
//
...
// который содержит все старые элементы и новый. В ином случае выводит в терминал сообщение "Строка <значение строки> в
// массиве уже есть"
